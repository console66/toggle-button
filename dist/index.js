(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["toggle-button"] = factory();
	else
		root["toggle-button"] = factory();
})(this, function() {
  ...
  computed: {
    ...
    circleStyle() {
      return {
        ...
        transform: this.active ? `translate3d(${this.moveLength}, ${this.marginLength}, 0)` : `translate3d(${this.marginLength}, ${this.marginLength}, 0)`
      };
    }
  },
  methods: {
...
// module
exports.push([module.i, ".switch-input[data-v-075f2f8f]{display:none}.switch-label[data-v-075f2f8f]{position:absolute;cursor:pointer;font-size:10px}.switch-label .switch-circle[data-v-075f2f8f]{border-radius:100%;background:#fff;position:absolute}.switch-label .switch-label-c[data-v-075f2f8f]{position:absolute;color:#fff;font-weight:700}.switch-label .switch-label-c.switch-left[data-v-075f2f8f]{left:6px}.switch-label .switch-label-c.switch-right[data-v-075f2f8f]{right:6px}.switch-label-active[data-v-075f2f8f]{background:green}.switch-label-deactive[data-v-075f2f8f]{background:#aaa}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), (_vm.label) ? [(_vm.active) ? _c('span', {
    staticClass: "switch-label-c switch-left",
    style: (_vm.switchLabelStyle),
    domProps: {
      "innerHTML": _vm._s(_vm.labelChecked)
    }
  }) : _c('span', {
    staticClass: "switch-label-c switch-right",
    style: (_vm.switchLabelStyle),
    domProps: {
...
var update = __webpack_require__(8)("026540ef", content, true);
